  ...
  return (
    <main className="legal-content">
      <div className="container">
        ...
        <section>
          <h2 className="static-h2">Éditeur du site</h2>
          <p>
        ...
        <section>
          <h2 className="static-h2">Hébergement</h2>
          <p>
        ...
        <section>
          <h2 className="static-h2">Propriété intellectuelle</h2>
          <p>
        ...
        <section>
          <h2 className="static-h2">Responsabilité</h2>
          <p>
